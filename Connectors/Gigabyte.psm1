<#
.SYNOPSIS
    Gigabyte connector for Software Manager Pro.
    Loads Gigabyte-specific apps from Apps JSON and registers fallback URL.
.VERSION
    1.0.0
#>
...
function Register-GigabyteConnector {
    ...
    Write-Log -Level "Debug" -Message "Gigabyte connector registered." -Module "Connectors"
}
