<#
.SYNOPSIS
    MSI connector for Software Manager Pro.
    Loads MSI-specific apps from Apps JSON and registers fallback URL.
.VERSION
    1.0.0
#>
...
function Register-MSIConnector {
    ...
    Write-Log -Level "Debug" -Message "MSI connector registered." -Module "Connectors"
}
