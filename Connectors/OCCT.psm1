<#
.SYNOPSIS
    OCCT connector for Software Manager Pro.
    Loads OCCT-specific apps from Apps JSON and registers fallback URL.
.VERSION
    1.0.0
#>
...
function Register-OCCTConnector {
    ...
    Write-Log -Level "Debug" -Message "OCCT connector registered." -Module "Connectors"
}
