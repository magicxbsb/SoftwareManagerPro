<#
.SYNOPSIS
    LianLi connector for Software Manager Pro.
    Loads LianLi-specific apps from Apps JSON and registers fallback URL.
.VERSION
    1.0.0
#>
...
function Register-LianLiConnector {
    ...
    Write-Log -Level "Debug" -Message "LianLi connector registered." -Module "Connectors"
}
