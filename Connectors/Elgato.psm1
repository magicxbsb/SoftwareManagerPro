<#
.SYNOPSIS
    Elgato connector for Software Manager Pro.
    Loads Elgato-specific apps from Apps JSON and registers fallback URL.
.VERSION
    1.0.0
#>
...
function Register-ElgatoConnector {
    ...
    Write-Log -Level "Debug" -Message "Elgato connector registered." -Module "Connectors"
}
