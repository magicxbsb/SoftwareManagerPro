<#
.SYNOPSIS
    NVIDIA connector for Software Manager Pro.
    Loads NVIDIA-specific apps from Apps JSON and registers fallback URL.
.VERSION
    1.0.0
#>
...
function Register-NVIDIAConnector {
    ...
    Write-Log -Level "Debug" -Message "NVIDIA connector registered." -Module "Connectors"
}
